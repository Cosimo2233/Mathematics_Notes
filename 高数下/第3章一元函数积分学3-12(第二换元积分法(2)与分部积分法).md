...
积
分
法 $\left\{\begin{array}{l}\text { 3．1．4 不定积分的换元积分法 }\left\{\begin{array}{l}\text { 第二换元积分法积分法 } \\ \text { 换元积分法习例1－5 }\end{array}\right. \\ \text { 3．1．5 不定积分的分部积分法 }\left\{\begin{array}{l}\text { 分部积分法 } \\ \text { 分部积分法习例6－19 }\end{array}\right.\end{array}\right.$
