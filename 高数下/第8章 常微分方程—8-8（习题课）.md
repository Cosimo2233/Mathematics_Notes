...
## （5）中南大学开放式精品示范课堂高等数学建设组

## 微分方程习题课

![](https://cdn.mathpix.com/cropped/58fe2e1a-ddbe-4342-80bc-510d047409a8-02.jpg?height=1040&width=1415&top_left_y=427&top_left_x=467)

## 一阶微分方程求解

1．一阶标准类型方程求解
三个标准类型 $\left\{\begin{array}{l}\text { 可分离变量方程 } \\ \text { 齐次方程 } \\ \text { 线性方程 }\end{array}\right.$
关键：辨别方程类型，掌握求解步骤
2．一阶非标准类型方程求解
变量代换法 $\left\{\begin{array}{l}\text { 代换自变量 } \\ \text { 代换因变量 } \\ \text { 代换某组合式 }\end{array}\right.$
...
- 常系数情形 $\left\{\begin{array}{l}\text { 齐次 } \\ \text { 非齐次 代数法 }\end{array}\right.$
- 欧拉方程
...
思考：能否根据草图列方程？
![](https://cdn.mathpix.com/cropped/58fe2e1a-ddbe-4342-80bc-510d047409a8-38.jpg?height=595&width=907&top_left_y=1062&top_left_x=1558)
