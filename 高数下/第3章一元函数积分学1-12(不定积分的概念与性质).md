...
| 大中夜面治山楽 | 3．1．1 原函数的概念 $\left\{\begin{array}{l}\text { 问题 } \\ \text { 原函数的定义 } \\ \text { 原函数的存在性 }\end{array}\right.$ <br> 3．1．2 不定积分的概念 $\left\{\begin{array}{l}\text { 定义 } \\ \text { 不定积分的几何意义 }\end{array}\right.$ <br> 3．1．3 基本积分表 <br> 3．1．2 不定积分的性质 <br> 求积分习例2－14 <br> 思考题——分段函数的不定积分 |
| :--- | :--- |
|  |  |
...
![](https://cdn.mathpix.com/cropped/b3d91931-e0ff-4469-81e9-df656abd881b-08.jpg?height=722&width=1208&top_left_y=935&top_left_x=588)
（8）（14）（－1）－
...
![](https://cdn.mathpix.com/cropped/b3d91931-e0ff-4469-81e9-df656abd881b-11.jpg?height=936&width=1317&top_left_y=935&top_left_x=150)
