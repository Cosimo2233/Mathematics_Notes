...
\section*{4.6 函数展开成正弦级数与余弦级数}

\begin{tabular}{|l|l|}
\hline ![](https://cdn.mathpix.com/cropped/0ebcdcd8-edca-4aa0-8ffd-6bd7f04e8267-02.jpg?height=1193\&width=117\&top_left_y=300\&top_left_x=166) & \begin{tabular}{l}
一．正弦级数与余弦级数 $\left\{\begin{array}{l}2 \pi \text { 为周期的正弦与余弦级数 } \\ \text { 习例1 } \\ 2 l \text { 为周期的正弦与余弦级数 }\end{array}\right.$ \\
二．定义在 $[0, \pi]$ 上的函数展成正弦级数与余弦级数 习例2 \\
三．定义在 $[0, l]$ 上的函数展成正弦级数 与余弦级数 习例3 \\
四．非对称区间上的函数展 成Fourier级数习例4－5 \\
习题课 $\left\{\begin{array}{l}\text { 内容小结 } \\ \text { 常见题型 } \\ \text { 典型习例 }\end{array}\right.$
\end{tabular} \\
\hline
\end{tabular}
...
解 将 $f(x)$ 作周期延拓，如图
![](https://cdn.mathpix.com/cropped/0ebcdcd8-edca-4aa0-8ffd-6bd7f04e8267-06.jpg?height=717&width=2125&top_left_y=617&top_left_x=213)
...
\section*{二．定义在 $[0, \pi]$ 上的函数展成正弦级数 与余弦级数}
...
![](https://cdn.mathpix.com/cropped/0ebcdcd8-edca-4aa0-8ffd-6bd7f04e8267-11.jpg?height=780&width=1923&top_left_y=681&top_left_x=207)
...
![](https://cdn.mathpix.com/cropped/0ebcdcd8-edca-4aa0-8ffd-6bd7f04e8267-12.jpg?height=756&width=2148&top_left_y=1119&top_left_x=196)
...
\section*{三．定义在 $[0, l]$ 上的函数展成正弦级数 与余弦级数}
...
解（1）将 $f(x)$ 作奇延拓，再作周期延拓。如图
![](https://cdn.mathpix.com/cropped/0ebcdcd8-edca-4aa0-8ffd-6bd7f04e8267-16.jpg?height=613&width=1773&top_left_y=1067&top_left_x=207)
...
（2）将 $f(x)$ 作偶延拓，再作周期延拓。如图
![](https://cdn.mathpix.com/cropped/0ebcdcd8-edca-4aa0-8ffd-6bd7f04e8267-18.jpg?height=474&width=2148&top_left_y=473&top_left_x=150)
...
\section*{四．非对称区间上的函数展 成Fourier级数}
...
![](https://cdn.mathpix.com/cropped/0ebcdcd8-edca-4aa0-8ffd-6bd7f04e8267-21.jpg?height=728&width=2139&top_left_y=934&top_left_x=229)
...
![](https://cdn.mathpix.com/cropped/0ebcdcd8-edca-4aa0-8ffd-6bd7f04e8267-23.jpg?height=722&width=2125&top_left_y=900&top_left_x=207)
...
1．幂级数 $\left\{\begin{array}{l}\text { 将函数展开成Taylor级数 } \\ \text { 利用已知Taylor展开式求幂级数的和函数 }\end{array}\right.$
![](https://cdn.mathpix.com/cropped/0ebcdcd8-edca-4aa0-8ffd-6bd7f04e8267-25.jpg?height=1196&width=2310&top_left_y=634&top_left_x=109)
