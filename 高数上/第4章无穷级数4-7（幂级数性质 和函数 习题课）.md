...
\section*{4.3 幂级数}
![](https://cdn.mathpix.com/cropped/7eb7fab6-632b-42df-a8cd-89f98e04ab9a-02.jpg?height=1057&width=1623&top_left_y=352&top_left_x=311)
...
∴ 收玫域为（－1，1）．
![](https://cdn.mathpix.com/cropped/7eb7fab6-632b-42df-a8cd-89f98e04ab9a-12.jpg?height=208&width=203&top_left_y=46&top_left_x=17)
...
\section*{例 4 求 $\sum_{n=1}^{\infty} \frac{n(n+1)}{2^{n}}$ 的和．}
...
1．数项级数 $\left\{\begin{array}{l}\text { 正项级数 } \\ \text { 交错级数 } \\ \text { 任意项级数 }\end{array}\right.$
2．幂级数 $\left\{\begin{array}{l}\text { 幕级数的收敛半径与收敛域 } \\ \text { 幂级数的和函数与数项级数的和 }\end{array}\right.$
