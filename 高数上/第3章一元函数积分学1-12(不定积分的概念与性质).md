...
3．1．1 原函数的概念 $\left\{\begin{array}{l}\text { 问题 } \\ \text { 原函数的定义 } \\ \text { 原函数的存在性 }\end{array}\right.$ \\
3．1．2 不定积分的概念 $\left\{\begin{array}{l}\text { 定义 } \\ \text { 不定积分的几何意义 }\end{array}\right.$ \\
3．1．3 基本积分表 \\
3．1．2 不定积分的性质 \\
求积分习例2－14 \\
思考题——分段函数的不定积分
...
\section*{例16．求 $\int e^{-|x|} \mathrm{d} x$ 。}
